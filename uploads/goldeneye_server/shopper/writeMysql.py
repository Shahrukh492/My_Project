...
data_path = '/A_goldeneye/uploads/goldeneye_server/processing/unique_images'
images = []
images1 = []
...
for i,file in enumerate(images):
    ...
    os.replace(file, f'/A_goldeneye/uploads/goldeneye_server/processed/Done/{images1[i]}')
