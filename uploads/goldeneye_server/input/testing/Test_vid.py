...
vids_path = '/A_goldeneye/uploads/goldeneye_server/input/Testing_21Feb'
target_path1 = '/A_goldeneye/uploads/goldeneye_server/processing/video'
target_path2 = '/A_goldeneye/uploads/goldeneye_server/subprocessing/video'
videos = []
vid_name = []
targ_vid = []
