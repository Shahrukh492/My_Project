...
data_path = '/home/centos/goldeneye/uploads/990d8147/processing/unique_images'
images = []
images1 = []
...
def insert(photo, deviceid, target_file, image_name):
    ...
    try:
        if len(face) == 0:
            ...
            text_file = open("/home/centos/goldeneye/Arsalan/logs/WriteMysql/{}.txt".format(str(today)), "a")
...
for i,file in enumerate(images):
    ...
    os.replace(file, f'/home/centos/goldeneye/uploads/990d8147/processed/done/{img_name}')
